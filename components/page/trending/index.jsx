...
import { MyCard, CardSkeleton } from 'components/page/trending/card'
import { Grid } from '@material-ui/core';
import Container from '@material-ui/core/Container';

const Trending = (props) => {
    const context = useContext(Context)
    const mode = props.mode //Static Mode
    const currentMode = context.state.mode // Dynamic Mode State
